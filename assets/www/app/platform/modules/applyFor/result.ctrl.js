(function () {
    ...
    ApplyForCtrl.$inject = ['$rootScope', '$scope', '$stateParams', '$ionicLoading', '$state', 'AccountService'];
    function ApplyForCtrl($rootScope, $scope, $stateParams, $ionicLoading, $state, AccountService) {
        var vm = this;
        ...
        function getResult(){
            $ionicLoading.show();
            AccountService.getDeclarationCoin(
                vm.id,
                vm.subAccountType
