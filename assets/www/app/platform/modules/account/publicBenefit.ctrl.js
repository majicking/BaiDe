(function () {
    ...
    /* Controllers */
    angular.module('app').controller('PublicBenefitCtrl', PublicBenefitCtrl);

    PublicBenefitCtrl.$inject = ['$rootScope', '$sessionStorage', '$scope', '$localStorage', '$ionicPopup', '$ionicLoading', 'AccountService', '$stateParams'];

    function PublicBenefitCtrl($rootScope, $sessionStorage, $scope, $localStorage, $ionicPopup, $ionicLoading, AccountService, $stateParams) {
        var vm = this;
