...
(function () {
    ...
    /* Controllers */
    angular.module('app').controller('QrcodelCtrl', QrcodelCtrl);

    QrcodelCtrl.$inject = ['$rootScope', '$sessionStorage', '$state', '$ionicLoading', 'AccountService'];
    function QrcodelCtrl($rootScope, $sessionStorage, $state, $ionicLoading, AccountService) {
        var vm = this;
