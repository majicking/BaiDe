...
(function () {
    ...
    PasswordCtrl.$inject = ['$rootScope', '$scope','$interval', '$ionicLoading', '$ionicNativeTransitions', 'UserService'];
    function PasswordCtrl($rootScope, $scope,$interval, $ionicLoading, $ionicNativeTransitions, UserService) {
        var vm = this;
