(function () {
    ...
    /* Controllers */
    angular.module('app').controller('ExchangeCtrl', ExchangeCtrl);
    ExchangeCtrl.$inject = ['$rootScope', '$scope', '$stateParams', '$ionicLoading', '$state', 'AccountService'];
    function ExchangeCtrl($rootScope, $scope, $stateParams, $ionicLoading, $state, AccountService) {
        var vm = this;
        ...
        function getResult(){
            $ionicLoading.show();
            AccountService.getExchangeResult(
                vm.id,
                vm.subAccountType
