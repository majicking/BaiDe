...
(function () {
    ...
    /* Controllers */
    angular.module('app').controller('OtcNbMySellsListCtrl', OtcNbMySellsListCtrl);

    OtcNbMySellsListCtrl.$inject = ['$stateParams', '$rootScope', '$scope', '$state', '$ionicPopover', 'OtcNbService', '$ionicLoading', '$ionicNativeTransitions'];
    function OtcNbMySellsListCtrl($stateParams, $rootScope, $scope, $state, $ionicPopover, OtcNbService, $ionicLoading, $ionicNativeTransitions) {
        var vm = this;
