(function () {
    ...
    angular.module('app').controller('OtcBuyDetailCtrl', OtcBuyDetailCtrl);
    OtcBuyDetailCtrl.$inject = ['$rootScope', '$scope', '$sessionStorage', '$ionicLoading', '$ionicPopup', '$ionicNativeTransitions', 'OtcService', 'BankCardService', 'AccountService', '$stateParams', 'UploadService'];
    function OtcBuyDetailCtrl($rootScope, $scope, $sessionStorage, $ionicLoading, $ionicPopup, $ionicNativeTransitions, OtcService, BankCardService, AccountService, $stateParams, UploadService) {
        var vm = this;
        ...
        function initPageElements(){
            ...
            if(otcType == '0'){ //挂卖单
                ...
                if(status == '0'){ //挂单中，发起人进入
                    ...
                    vm.pageElementCon.isCurrentUser = false;
                    vm.pageElementCon.isCanUpdate = false;
                    vm.pageElementCon.isOptions = true;
