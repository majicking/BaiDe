(function () {
    ...
    angular.module('app').controller('OtcMySellsDetailNbCtrl', OtcMySellsDetailNbCtrl);
    OtcMySellsDetailNbCtrl.$inject = ['$rootScope', '$scope', '$sessionStorage', '$ionicLoading', '$ionicPopup', '$ionicNativeTransitions', 'OtcNbService', 'BankCardService', 'AccountService', '$stateParams'];
    function OtcMySellsDetailNbCtrl($rootScope, $scope, $sessionStorage, $ionicLoading, $ionicPopup, $ionicNativeTransitions, OtcNbService, BankCardService, AccountService, $stateParams) {
        var vm = this;
