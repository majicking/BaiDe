                    ...
                    pre: function preLink(scope, element, attrs, controller) {
                        ...
                        scope.showBigImage = function(imageName) {
                            ...
                            $(".LightBox").show(150, function() {
                                //$("ion-view").attr("hide-tabs").value = true;
                                //$('ion-view').attr('hide-nav-bar').value = true;
                                //$("ion-header-bar").getElementsByClassName("nav-bar-block").hide();
                                //$(".Main .tab-nav").hide();
                                //$('ion-content').setAttribute('scroll', 'true');
                                //element.find("ion-content").setAttr('scroll', 'false');
                                //document.documentElement.getElementsByTagName("ion-header-bar").setAttribute('hide-tabs', 'true');
                                $(".LightBox .ImgViewer img").each(function() {
                                    ...
                                    $(".LightBox").css({
                                        height: document.documentElement.clientHeight-47
                                    });
